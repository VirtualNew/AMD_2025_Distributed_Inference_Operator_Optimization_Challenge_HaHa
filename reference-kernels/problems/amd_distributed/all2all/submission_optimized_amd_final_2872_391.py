...
# ---------------- Final AMD ROCm Optimized Packed All2All Implementation ----------------
class FinalAMDOptimizedPackedAllToAll:
...
def custom_kernel(data: input_t) -> output_t:
    ...
    ata = FinalAMDOptimizedPackedAllToAll(cfg, rank, world_size)

    # Dispatch tokens to experts
    expert_num, expert_x, expert_meta = ata.dispatch(rank_data.x, rank_data.indices)

    # Expert computation (simulated)
    # AMD optimization: Use bfloat16 for better performance on AMD GPUs when available
